...
function LandingFooter() {
  return (
    <footer className=" border-t border-neutral-300 py-2 md:py-0">
      <div className="max-w-[1400px] flex items-center justify-between h-full md:h-14 m-auto px-5 md:px-20 2xl:px-0 ">
        <div>
